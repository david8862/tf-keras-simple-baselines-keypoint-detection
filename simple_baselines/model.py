...
def get_simple_baselines_model(model_type, num_classes, model_input_shape=None, freeze_level=0, weights_path=None):
    ...
    if freeze_level in [1, 2]:
        ...
        num = (backbone_len, len(model.layers)-1)[freeze_level-1]
