...
# -*- coding: utf-8 -*-
"""
Script to convert Simple Baselines keras model to ONNX model
"""
...
def main():
    parser = argparse.ArgumentParser(argument_default=argparse.SUPPRESS, description='Convert Simple Baselines tf.keras model to ONNX model')
