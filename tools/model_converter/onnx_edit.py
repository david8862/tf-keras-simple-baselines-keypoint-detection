...
# -*- coding: utf-8 -*-
"""
Script to modify converted Simple Baselines ONNX model to remove "Transpose" OP
...
def main():
    parser = argparse.ArgumentParser(argument_default=argparse.SUPPRESS, description='edit Simple Baselines onnx model to delete the Transpose OP at head')
    parser.add_argument('--input_model', help='input Simple Baselines onnx model file to edit', type=str, required=True)
