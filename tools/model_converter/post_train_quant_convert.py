...
# -*- coding: utf-8 -*-
"""
Script to convert Simple Baselines keras model to an integer quantized tflite model
...
def main():
    parser = argparse.ArgumentParser(argument_default=argparse.SUPPRESS, description='TF 2.x post training integer quantization converter for Simple Baselines keypoint detection model')
