...
with trained Simple Baselines model
...
def main():
    parser = argparse.ArgumentParser(description='check featuremap activation of specified layer with trained Simple Baselines model')
