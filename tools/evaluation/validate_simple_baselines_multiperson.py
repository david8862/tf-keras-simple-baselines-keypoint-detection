...
def predict_simple_baselines_model_mnn(interpreter, session, image, loop_count):
...
def predict_simple_baselines_model_onnx(model, image, loop_count):
    input_tensors = []
    ...
    for image_file in image_files:
        ...
        for box, score in zip(person_boxes, person_scores):
            ...
            # support of MNN model
                ...
                keypoints = predict_simple_baselines_model_mnn(model, session, person_image, args.loop_count)
            ## support of TF 1.x frozen pb model
            ...
            # support of ONNX model
                ...
                keypoints = predict_simple_baselines_model_onnx(model, person_image, args.loop_count)
            ## normal keras h5 model
