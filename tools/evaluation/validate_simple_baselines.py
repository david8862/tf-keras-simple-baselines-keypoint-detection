...
from common.utils import get_classes, get_skeleton, render_skeleton, get_custom_objects, optimize_tf_gpu
...
def validate_simple_baselines_model(model, image_file, class_names, skeleton_lines, model_input_shape, loop_count, output_path):
...
def validate_simple_baselines_model_tflite(interpreter, image_file, class_names, skeleton_lines, loop_count, output_path):
...
def validate_simple_baselines_model_mnn(interpreter, session, image_file, class_names, skeleton_lines, loop_count, output_path):
...
def validate_simple_baselines_model_onnx(model, image_file, class_names, skeleton_lines, loop_count, output_path):
    input_tensors = []
...
def validate_simple_baselines_model_pb(model, image_file, class_names, skeleton_lines, model_input_shape, loop_count, output_path):
...
def main():
    ...
    for image_file in image_files:
        ...
        if args.model_path.endswith('.tflite'):
            validate_simple_baselines_model_tflite(model, image_file, class_names, skeleton_lines, args.loop_count, args.output_path)
        # support of MNN model
        elif args.model_path.endswith('.mnn'):
            validate_simple_baselines_model_mnn(model, session, image_file, class_names, skeleton_lines, args.loop_count, args.output_path)
        ## support of TF 1.x frozen pb model
        elif args.model_path.endswith('.pb'):
            validate_simple_baselines_model_pb(model, image_file, class_names, skeleton_lines, model_input_shape, args.loop_count, args.output_path)
        # support of ONNX model
        elif args.model_path.endswith('.onnx'):
            validate_simple_baselines_model_onnx(model, image_file, class_names, skeleton_lines, args.loop_count, args.output_path)
        ## normal keras h5 model
        elif args.model_path.endswith('.h5'):
            validate_simple_baselines_model(model, image_file, class_names, skeleton_lines, model_input_shape, args.loop_count, args.output_path)
        else:
            raise ValueError('invalid model file')
